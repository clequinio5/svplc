	...
	Public Class FormCO1
		...
		Private Overridable Property BackgroundWorkercomb As BackgroundWorker
			...
			Set(ByVal value As BackgroundWorker)
				Dim formCO1 As SVPLCApplication.FormCO1 = Me
				Dim runWorkerCompletedEventHandler As System.ComponentModel.RunWorkerCompletedEventHandler = New System.ComponentModel.RunWorkerCompletedEventHandler(AddressOf formCO1.BackgroundWorker_RunWorkerCompleted)
				Dim formCO11 As SVPLCApplication.FormCO1 = Me
				Dim doWorkEventHandler As System.ComponentModel.DoWorkEventHandler = New System.ComponentModel.DoWorkEventHandler(AddressOf formCO11.BackgroundWorker_DoWork)
		...
		Public Sub New()
			MyBase.New()
			Dim formCO11 As FormCO1 = Me
			AddHandler MyBase.Load,  New EventHandler(AddressOf formCO11.Form7_Load)
			Dim formCO12 As FormCO1 = Me
			AddHandler MyBase.FormClosed,  New FormClosedEventHandler(AddressOf formCO12.FormCO1_FormClosed)
		...
		Private Sub BackgroundWorker_DoWork(ByVal sender As Object, ByVal e As DoWorkEventArgs)
			...
			Do
				...
				Do
					...
					Dim rESULTSROT1 As Label = Me.tab(1, num3)
					rESULTSROT1.TextAlign = ContentAlignment.MiddleCenter
					rESULTSROT1.Text = Module1.RESULTSROT1(num1 + 1, num3 + 1)
					rESULTSROT1.Font = New System.Drawing.Font("Times new roman", CSng(Me.police))
					rESULTSROT1.ForeColor = Color.Black
		...
		Private Sub Form7_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			Dim str() As String = { "Il y a ", Conversions.ToString(Module1.nbrrotationoptimisees1), " solutions optimisées parmis ", Conversions.ToString(Module1.factnumeroparcelle), " possibles et dont la note est de ", Conversions.ToString(Module1.NOTEMAX1), " sur une échelle allant de -", Conversions.ToString(Module1.nbrfrontierespartagees + Module1.nbrcellulesutilisees), " à ", Conversions.ToString(Module1.nbrfrontierespartagees + Module1.nbrcellulesutilisees), " ." }
			label1.Text = String.Concat(str)
			If (Module1.nbrrotationoptimisees1 <= 120) Then
				Me.nbrsolutionsaffichees = Module1.nbrrotationoptimisees1
			Else
		...
		Private Sub FormCO1_FormClosed(ByVal sender As Object, ByVal e As FormClosedEventArgs)
			Module1.loadcombrot1 = False
		End Sub

		<DebuggerStepThrough>
		Private Sub InitializeComponent()
			Dim componentResourceManager As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(FormCO1))
			...
			Dim point As System.Drawing.Point = New System.Drawing.Point(60, 25)
			...
			Me.GroupBoxCombinaisons.ForeColor = Color.FromArgb(0, 192, 0)
			...
			groupBox.Margin = padding
			Me.GroupBoxCombinaisons.Name = "GroupBoxCombinaisons"
			Dim groupBoxCombinaisons1 As System.Windows.Forms.GroupBox = Me.GroupBoxCombinaisons
			padding = New System.Windows.Forms.Padding(4)
			groupBoxCombinaisons1.Padding = padding
			Dim groupBox1 As System.Windows.Forms.GroupBox = Me.GroupBoxCombinaisons
			...
			Me.AutoScaleDimensions = New SizeF(9!, 16!)
			...
			Me.Font = New System.Drawing.Font("Microsoft Sans Serif", 9.75!, FontStyle.Bold, GraphicsUnit.Point, 0)
			...
			Me.Name = "FormCO1"
			Me.Text = "Combinaisons optimisées année +1"
